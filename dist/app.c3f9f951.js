...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var resultDsiplay = document.querySelector('.result');
  var width = 4;
  var winScore = 2048;
  var score = 0;
  var squares = []; //create a playing board;

  function createBoard() {
    for (var i = 0; i < width * width; i++) {
      var square = document.createElement('div');
      var num = 0;
      square.innerHTML = "<span class=\"num\" data-num=".concat(num, "></span>");
  ...
  function generate() {
    ...
    if (squares[randomNumber].children[0].getAttribute('data-num') == 0) {
      var num = 2;
      squares[randomNumber].innerHTML = "<span class=\"num\" data-num=".concat(num, "></span>"); // checkForGameOver();
    } else generate();
  } //swipe right
  ...
  function moveRight() {
    for (var i = 0; i < width * width; i++) {
      if (i % 4 === 0) {
        //0,4,8,12
        //get each num in row
        var totalOne = squares[i].children[0].getAttribute('data-num');
        var totalTwo = squares[i + 1].children[0].getAttribute('data-num');
        var totalThree = squares[i + 2].children[0].getAttribute('data-num');
        var totalFour = squares[i + 3].children[0].getAttribute('data-num');
        var row = [parseInt(totalOne), parseInt(totalTwo), parseInt(totalThree), parseInt(totalFour)]; // console.log(row)
  ...
  function moveDown() {
    for (var i = 0; i < width; i++) {
      var totalOne = squares[i].children[0].getAttribute('data-num');
      var totalTwo = squares[i + width].children[0].getAttribute('data-num');
      var totalThree = squares[i + width * 2].children[0].getAttribute('data-num');
      var totalFour = squares[i + width * 3].children[0].getAttribute('data-num');
      ...
      var missing = width - filteredColumn.length;
      var zeros = Array(missing).fill(0);
  ...
  function combineRow() {
    for (var i = 0; i < 15; i++) {
      if (squares[i].children[0].getAttribute('data-num') === squares[i + 1].children[0].getAttribute('data-num')) {
        var combinedTotal = parseInt(squares[i].children[0].getAttribute('data-num')) + parseInt(squares[i + 1].children[0].getAttribute('data-num'));
  ...
  function combineColumn() {
    for (var i = 0; i < 12; i++) {
      if (squares[i].children[0].getAttribute('data-num') === squares[i + width].children[0].getAttribute('data-num')) {
        var combinedTotal = parseInt(squares[i].children[0].getAttribute('data-num')) + parseInt(squares[i + width].children[0].getAttribute('data-num')); // console.log(squares[i].children[0].innerHTML)
